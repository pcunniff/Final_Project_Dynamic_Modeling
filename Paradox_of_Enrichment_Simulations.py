...
b = 0.8
# a represents alpha (1 / carrying capacity)
a = 0.00125
...
params = (b, a, w, d, e, s) # params given in the order provided above, aside from the alpha value that varies every trial
